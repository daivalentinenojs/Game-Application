...
namespace Core_DB_Competition
{
    public partial class Story_Line_1 : Form
    {
        ...
        internal Story_Line_1(int nilai, int suara)
        {
            InitializeComponent();
            story = nilai;
            sound = suara;
        ...
        System.Media.SoundPlayer SoundStory = new System.Media.SoundPlayer(Application.StartupPath + "\\Music\\Story1.wav");
        ...
        private void Story_Line_1_Load(object sender, EventArgs e)
        {
            if (story == 1)
            {
                this.BackgroundImage = Image.FromFile(Application.StartupPath + "\\StoryLine1\\1-1.jpg");
            }
            else if (story == 7)
            {
                this.BackgroundImage = Image.FromFile(Application.StartupPath + "\\StoryLine1\\1-7.jpg");
            }
        ...
        private void picBack_Click(object sender, EventArgs e)
        {
            ...
            {
                this.BackgroundImage = Image.FromFile(Application.StartupPath + "\\StoryLine1\\1-2.jpg");
            }
            else if (story == 3)
            {
                this.BackgroundImage = Image.FromFile(Application.StartupPath + "\\StoryLine1\\1-3.jpg");
            }
            else if (story == 4)
            {
                this.BackgroundImage = Image.FromFile(Application.StartupPath + "\\StoryLine1\\1-4.jpg");
            }
            else if (story == 5)
            {
                this.BackgroundImage = Image.FromFile(Application.StartupPath + "\\StoryLine1\\1-5.jpg");
            }
            else if (story == 6)
            {
                this.BackgroundImage = Image.FromFile(Application.StartupPath + "\\StoryLine1\\1-6.jpg");
            }
        }
