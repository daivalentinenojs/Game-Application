...
namespace Penjadwalan_CPU
{
    public partial class Map : Form
    {
        ...
        {
            MessageBox.Show("Belajarlah Dahulu Di Rumah FCFS !!","Informasi");
        }
        ...
        private void pictureBox1_MouseHover(object sender, EventArgs e)
        {
            ...
            pictureBox5.Image = Image.FromFile(Application.StartupPath + "\\Map\\yes.png");
        }
