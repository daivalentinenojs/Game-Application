...
namespace Penjadwalan_CPU
{
    public partial class Map_3 : Form
    {
        ...
        private void Map_3_Load(object sender, EventArgs e)
        {
        ...
        {
            MessageBox.Show("Belajarlah Dahulu Di Rumah SJF Non Preemptive !!", "Informasi");
        }

        private void pictureBox2_Click(object sender, EventArgs e)
        {
            CPU_SJF_NE form = new CPU_SJF_NE();
            this.Hide();
            form.ShowDialog();
            this.Close();
        }
        ...
        private void pictureBox2_MouseHover(object sender, EventArgs e)
        {
            ...
            pictureBox7.Image = Image.FromFile(Application.StartupPath + "\\Map\\yes.png");
        }
