...
public class beliBajuPelayan : MonoBehaviour {
    public Sprite bajuLV0;
    public Sprite bajuLV1;
    public Sprite bajuLV2;
    public Sprite bajuLV3;
    ...
    void OnMouseExit()
    {
        ...
        if (Database.upgradeBajuPelayan == 1)
        {
    ...
    void OnMouseDown()
    {
        ...
        print("Uang Anda Tersisa : " + Database.uang + " Level Baju Pelayan : " + Database.upgradeBajuPelayan);
